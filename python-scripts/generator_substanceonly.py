...
#OUTDIR = "C:\\Users\\Toby\\Documents\\vrchatshit\\liarsdice\\world\\textures"
OUTDIR = "C:\\Users\\Toby\\Documents\\vrchatshit\\unity\\Liars Dice 2019\\Assets\\Textures\\matpal"
...
def main():
    ...
    for mapname, data in maps.items():
        ...
        img.save(os.path.join(OUTDIR, f"{mapname}.png"))
...
def metalsmooth(tile, imgfiles):
    return getImgLike(tile, imgfiles, SIGS['metal'])
